...
define('JPATH_CACHE', dirname(dirname(__FILE__)).'/joomla-cms.my/cache'   );
define('JPATH_COMPONENT', dirname(dirname(__FILE__)).'/jUpgradePro.free/trunk/admin' );
define('JPATH_COMPONENT_ADMINISTRATOR', dirname(dirname(__FILE__)).'/jUpgradePro.free/trunk/admin');
