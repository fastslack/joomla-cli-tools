...
?>
<form
	action="<?php echo Route::_('index.php?option=com_{OPTIONNAME}&view={VIEWNAME}&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="row-fluid">
		...
		<div>
			...
			<div class="span6 form-horizontal">
				<?php echo $this->form->renderField('{VIEWNAME}s'); ?>
			</div>
		</div>
	...
	<input name="jform[id]" id="jform_id" value="<?php echo $this->item->id; ?>" class="readonly" readonly=""
	       type="hidden">
